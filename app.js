...
const TRAITS = [
  ...
  {
    id:16, emoji:'🛡️',
    ar:{title:'حقوق الإنسان في الإسلام مقابل الماركسية',desc:'الإسلام كفل حقوق الإنسان قبل الإعلان العالمي بأربعة عشر قرناً. حق الحياة والكرامة والملكية والتعبير والعدالة مصونة في الشريعة. الماركسية سحقت الفرد لصالح الدولة وحوّلت الإنسان إلى ترس في آلة الإنتاج. الإسلام يوازن بين حقوق الفرد وحقوق المجتمع دون طغيان أحدهما على الآخر. خطبة الوداع كانت أول وثيقة حقوقية شاملة في التاريخ البشري.',verse:'مَنْ قَتَلَ نَفْسًا بِغَيْرِ نَفْسٍ أَوْ فَسَادٍ فِي الْأَرْضِ فَكَأَنَّمَا قَتَلَ النَّاسَ جَمِيعًا',verseRef:'المائدة ٣٢',hadith:'إن دماءكم وأموالكم وأعراضكم عليكم حرام — خطبة الوداع',action:'اقرأ عن حقوق الإنسان في خطبة الوداع وقارنها بالمواثيق الحديثة — ستجد أن الإسلام سبقها بقرون',young:'الإسلام حمى حقوقك قبل أن يولد أي قانون حديث! تعلم عن حقوقك في الإسلام 🛡️'},
    en:{title:'Human Rights: Islam vs Marxism',desc:'Islam guaranteed human rights fourteen centuries before the Universal Declaration. The right to life, dignity, property, expression, and justice are protected in Shariah. Marxism crushed the individual for the sake of the state and turned humans into cogs in the production machine. Islam balances individual rights and community rights without either dominating the other. The Farewell Sermon was the first comprehensive human rights document in human history.',verse:'Whoever kills a soul unless for a soul or for corruption in the land, it is as if he had slain all mankind',verseRef:'Al-Maidah 32',hadith:'Your blood, your wealth, and your honor are sacred — Farewell Sermon',action:'Read about human rights in the Farewell Sermon and compare them with modern charters — you will find Islam preceded them by centuries',young:'Islam protected your rights before any modern law was born! Learn about your rights in Islam 🛡️'},
